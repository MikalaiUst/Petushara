...
class Level(BaseWindow):
    ...
    def board(self,surface):
        ...
        final_score = self.def_score + self.coin_num*self.coin_reward - (5-self.hp_num)*self.hp_penalty - time_penalty
        final_score = final_score - final_score%5

        self.player_interface.draw_interface(surface,self.hp_num,self.coin_num,int(final_score),self.cur_time,self.time_limit)
