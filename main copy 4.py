...
class Level(BaseWindow):
    def __init__(self,level_name):
        file = open("level_maps/"+level_name+".txt", "r")
        print(file)
    ...
    def board(self,surface):
        ...
        pygame.draw.rect(surface, (255,255,255), pygame.Rect(0,0,200,200))
        pygame.draw.rect(surface, (0,0,0), (300+self.camera_pos[0],300+self.camera_pos[1],20,20))
        pygame.draw.circle(surface,(255,255,0),(600,400),56)
    def event_enter(self, event):
...
log_in_screen = LogInWindow()       #login screen with username/password fields and messages
main_menu_screen = MainMenuWindow() #main menu where user chooses what to do next
level_1 = Level("level_1")              #placeholder for the first level of the game
window_list = [log_in_screen,main_menu_screen,level_1]
