...
class Level(BaseWindow):
    def __init__(self, level_name):
        ...
        for line in file.readlines():
            ...
            for element in line.strip().split(","):
                ...
                if element == "4":
                    self.active_projectiles.append(Projectile(x_pos,y_pos,0,5,pi,projectile_size))
                if element == "5":
    ...
    def board(self,surface):
        ...
        for turret in self.world_turrets:
            ...
            surface.blit(turret_bottom, obj.tile_rect)
...
class Turret:
    def __init__(self, x, y, tile_size,ranger):
