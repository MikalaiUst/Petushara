...
class Message:
    def __init__(self,coords:pygame.Rect,text,is_choice,padding,font_size):
        ...
        self.coords.height = height+self.font.get_height()
...
message = Message(pygame.Rect(300,300,800,200),"erg erwg 23ertg j45o[hn erg ewrgewrg erg we rg erg8u ewrtgw ewrtew hrere gewgwer ergwergw eargs werg werg werg4w gergwerg ergewrgwe ergwer yujmku",False,20,30)
